		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomprojectdialog1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomprojectdialog1-display": {
								"semanticObject": "arcomprojectdialog1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.projectdialog1",
									"url": sap.ui.require.toUrl("ar/com/projectdialog1")
								}
							}
						}
					}
