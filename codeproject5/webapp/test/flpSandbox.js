		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomcodeproject5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomcodeproject5-display": {
								"semanticObject": "arcomcodeproject5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.codeproject5",
									"url": sap.ui.require.toUrl("ar/com/codeproject5")
								}
							}
						}
					}
