		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomnorthwind05-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomnorthwind05-display": {
								"semanticObject": "arcomnorthwind05",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.northwind05",
									"url": sap.ui.require.toUrl("ar/com/northwind05")
								}
							}
						}
					}
