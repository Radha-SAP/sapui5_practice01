		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomodatav401-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomodatav401-display": {
								"semanticObject": "arcomodatav401",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.odatav401",
									"url": sap.ui.require.toUrl("ar/com/odatav401")
								}
							}
						}
					}
