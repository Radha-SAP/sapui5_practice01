		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomprojectnorthwind3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomprojectnorthwind3-display": {
								"semanticObject": "arcomprojectnorthwind3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.projectnorthwind3",
									"url": sap.ui.require.toUrl("ar/com/projectnorthwind3")
								}
							}
						}
					}
