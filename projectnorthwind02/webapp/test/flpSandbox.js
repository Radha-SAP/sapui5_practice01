		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomprojectnorthwind02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomprojectnorthwind02-display": {
								"semanticObject": "arcomprojectnorthwind02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.projectnorthwind02",
									"url": sap.ui.require.toUrl("ar/com/projectnorthwind02")
								}
							}
						}
					}
