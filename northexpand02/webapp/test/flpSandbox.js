		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomnorthexpand02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomnorthexpand02-display": {
								"semanticObject": "arcomnorthexpand02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.northexpand02",
									"url": sap.ui.require.toUrl("ar/com/northexpand02")
								}
							}
						}
					}
