		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Formatter",
									"targetURL": "#arcomprojectlistformatter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomprojectlistformatter-display": {
								"semanticObject": "arcomprojectlistformatter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.projectlistformatter",
									"url": sap.ui.require.toUrl("ar/com/projectlistformatter")
								}
							}
						}
					}
