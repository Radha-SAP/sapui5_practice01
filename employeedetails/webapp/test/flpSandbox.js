		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#arcomemployeedetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomemployeedetails-display": {
								"semanticObject": "arcomemployeedetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.employeedetails",
									"url": sap.ui.require.toUrl("ar/com/employeedetails")
								}
							}
						}
					}
