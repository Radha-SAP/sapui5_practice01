		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#radhacomproject5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"radhacomproject5-display": {
								"semanticObject": "radhacomproject5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=radha.com.project5",
									"url": sap.ui.require.toUrl("radha/com/project5")
								}
							}
						}
					}
